...
// const speak = (text) => {
//   if (!text) return;
//   window.speechSynthesis.cancel(); // stop anything speaking
//   const utterance = new SpeechSynthesisUtterance(text);
...
//     const phoneNumber = encodeURIComponent(userInput);
//     window.open(`tel:${phoneNumber}`);
//   }

//   if (type === 'send-email') {
//     const email = encodeURIComponent(userInput);
...
//   //     //if user is not speaking then  only start recognition
//   //     recognition.start()
//   //   }
...
//     try {
//       recognition.start();
//       console.log("Recognition requsted to start");
//     } catch (error) {
...
//       if (data?.response) {
//         console.log("Calling speak with:", data.response);
//         speak(data.response);
//         //calling handlecommand function
//         handleCommand(data);
//       } else {
...
//   return (
//     <div className='w-full h-[100vh] overflow-y-auto bg-gradient-to-t from-[black] to-[#181879] flex justify-center items-center flex-col gap-[15px]'>
//       <button
//   className="
//     absolute 
//     top-[10px] right-[10px] 
//     sm:top-[15px] sm:right-[15px] 
//     md:top-[20px] md:right-[20px] 
//     min-w-[100px] h-[40px] 
//     sm:min-w-[120px] sm:h-[45px] 
//     md:min-w-[140px] md:h-[50px] 
//     lg:min-w-[160px] lg:h-[50px]
...
//     absolute 
//     top-[70px] right-[10px] 
//     sm:top-[80px] sm:right-[15px] 
//     md:top-[100px] md:right-[20px] 
//     min-w-[150px] h-[50px] 
//     sm:min-w-[170px] sm:h-[55px] 
//     md:min-w-[180px] md:h-[60px] 
//     lg:min-w-[200px] lg:h-[60px]
//     bg-white rounded-full text-black font-semibold 
//     text-sm sm:text-base md:text-lg 
//     px-[15px] py-[8px] sm:px-[20px] sm:py-[10px]
//     cursor-pointer hover:bg-gray-200 transition duration-300
//   "
