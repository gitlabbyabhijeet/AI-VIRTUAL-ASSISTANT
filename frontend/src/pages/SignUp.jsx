...
//     e.preventDefault();  // it stops refresh
//     setErr("");
//     setLoading(true)
//     try{
//       let result = await axios.post(`${serverUrl}/api/auth/signup`,{
//         name,email,password
//       },{withCredentials:true}) //to parse token generated during signup in cookies we can make withCredentials as true it helps to parse token in cookies
...
//     <form className='w-[90%] h-[600px] max-w-[500px] bg-[#0000003d] 
//     backdrop-blur shadow-lg shadow-black-900 flex flex-col items-center justify-center gap-[20px]' onSubmit={handleSignUp}>
...
//             <input type="text" placeholder='Enter Your Name' className='w-[90%] h-[60px] outline-none border-2 border-white bg-transparent
...
//             <input type="email" placeholder='Email' className='w-[90%] h-[60px] outline-none border-2 border-white bg-transparent
...
//               {showPassword && <IoEyeOff className='absolute top-[18px] right-[20px] w-[25px] h-[25px] cursor-pointer' onClick={()=>setShowPassword(false)} />}
//             </div>
...
//                 >Already have an account ? <span className='text-blue-950'>Sign In</span></p>
//     </form>
//     </div>
//   )
// }
