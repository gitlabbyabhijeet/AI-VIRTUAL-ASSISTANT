...
//       // Redirect or update context here if needed
//     } catch (error) {
...
//       <form
//         className='w-[90%] h-[600px] max-w-[500px] bg-[#0000003d] backdrop-blur shadow-lg shadow-black-900 flex flex-col items-center justify-center gap-[20px]'
...
//           type="email"
//           placeholder='Email'
//           className='w-[90%] h-[60px] outline-none border-2 border-white bg-transparent text-white placeholder-gray-300 px-[20px] py-[10px] rounded-full text-[18px]'
//           required
...
//           ) : (
//             <IoEyeOff className='absolute top-[18px] right-[20px] w-[25px] h-[25px] cursor-pointer' onClick={() => setShowPassword(false)} />
//           )}
//         </div>
...
//           Want to create a new account? <span className='text-blue-950'>Register</span>
//         </p>
//       </form>
//     </div>
//   );
